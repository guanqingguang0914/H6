...
typedef enum{
    ...
    IN_CMD_WALK_P_KNEE_GAIN,
    IN_CMD_WALK_P_ANKLE_PITCH_GAIN,
    IN_CMD_WALK_P_HIP_ROLL_GAIN,
    IN_CMD_WALK_P_ANKLE_ROLL_GAIN,
    IN_CMD_WALK_P_GAIN,
    IN_CMD_WALK_I_GAIN,
    IN_CMD_WALK_D_GAIN,
...
static const struct {
  ...
  { "walk_auto_pose", IN_CMD_WALK_AUTO_POSE },
  ...
  { "walk_p_knee_gain", IN_CMD_WALK_P_KNEE_GAIN },
  { "walk_p_ankle_pitch_gain", IN_CMD_WALK_P_ANKLE_PITCH_GAIN },
  { "walk_p_hip_roll_gain", IN_CMD_WALK_P_HIP_ROLL_GAIN },
  { "walk_p_ankle_roll_gain", IN_CMD_WALK_P_ANKLE_ROLL_GAIN },
