...
void MotionManager::Process()
{
    ...
    if(m_CalibrationStatus == 0 || m_CalibrationStatus == -1)
    {
        ...
        {
            //fb_gyro_array[buf_idx] = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_GYRO_Y_L);//wuhua
            //rl_gyro_array[buf_idx] = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_GYRO_X_L);//wuhua
            fb_gyro_array[buf_idx] = gyro_x;
            rl_gyro_array[buf_idx] = gyro_y;
            buf_idx++;
        }
        else
        {
    ...
    if(m_CalibrationStatus == 1 && m_Enabled == true)
    {
        ...
        static int buf_idx = 0;
        //MotionStatus::FB_GYRO = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_GYRO_Y_L) - m_FBGyroCenter;//wuhua
        //MotionStatus::RL_GYRO = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_GYRO_X_L) - m_RLGyroCenter;//wuhua
        //MotionStatus::RL_ACCEL = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_ACCEL_X_L);//wuhua
        //MotionStatus::FB_ACCEL = m_CM730->m_BulkReadData[CM730::ID_CM].ReadWord(CM730::P_ACCEL_Y_L);//wuhua

        MotionStatus::FB_GYRO = gyro_x - m_FBGyroCenter;
        MotionStatus::RL_GYRO = gyro_y - m_RLGyroCenter;
